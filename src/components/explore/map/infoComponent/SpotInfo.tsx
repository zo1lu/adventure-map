    ...
    <div className="w-[360px] h-[500px] absolute flex flex-col p-5 top-24 right-8 bg-white rounded-md ">
      ...
      <div className='overflow-y-scroll'>
        <div className='w-full flex mb-2 justify-between'>
          <input value={spotInfo.title} className="w-[calc(100%-48px)] h-8 outline-none focus:border-b-[1px] focus:border-black text-xl font-bold uppercase" placeholder='Spot Title' />
          {/* {id&&spotImg.id==""?
        ...
        <select value={spotInfo.spot_type_id} className='h-10 w-[calc(100%-10px)] py-3 mt-1 text-xs outline-1 outline-gray-100'>
        ...
        <div className='h-8 w-full flex'>
          ...
          <input
              ...
              readOnly
          />
          <select value={spotInfo.start_time_zone}  className='h-full w-[80px] px-1 text-xs outline-1 outline-gray-100' name='start_time_zone' >
        ...
        <div className='h-8 w-full flex'>
          ...
          <input
              ...
              readOnly
          />
          <select className='h-full w-[80px] px-1 text-xs outline-1 outline-gray-100' value={spotInfo.end_time_zone} name='end_time_zone' >
        ...
        <textarea value={spotInfo.description} className="w-full py-3 outline-none min-h-[120px] text-xs"></textarea>
      </div>
